...
const Navbar = ({ title, onTitleChange }) => {
  ...
  return (
    <>
      ...
      {isExporting && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-gray-900 text-white px-5 py-3 rounded-lg shadow-2xl text-sm font-medium animate-in fade-in slide-in-from-bottom-4 duration-300 flex items-center gap-3 print:hidden border border-gray-700">
